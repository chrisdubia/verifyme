...
// Force ArrayBuffer backed Uint8Array copies (avoids SharedArrayBuffer typing issues)
const sigFixed = new Uint8Array(sig.byteLength);
sigFixed.set(sig);

const msgFixed = new Uint8Array(msg.byteLength);
msgFixed.set(msg);
